...
conn = sqlite3.connect('/Users/halilhelvaci/Desktop/Spring 2022/CS 628 Data Mining/Final Project/data/KG-Type-Correction-main/features/data/corpus.db')
...
def export():
    ...
    with open(f'results/{lego}_predictions.tsv', 'w') as f:
...
def run_query(model, size, strategy='uncertainty'):
    ...
    if strategy == 'uncertainty':
        examples = rank_uncertainty(model)
    else:
        examples = rank_err_reduction(model)
...
def train():
    ...
    with open('/Users/halilhelvaci/Desktop/Spring 2022/CS 628 Data Mining/Final Project/data/KG-Type-Correction-main/features/data/priors.pkl', 'rb') as f:
